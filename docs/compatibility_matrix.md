...
This matrix describes the NexStar5/8-Bridge v1.0.0 release.

Status values:

- **Checked** — exercised during the current v1.0.0 validation sequence.
- **Partial** — some paths were exercised, but the complete matrix remains.
- **Pending** — needs a dedicated repeatable test run.

| Surface | v1.0.0 status | Evidence or remaining coverage |
| --- | --- | --- |
...
| Long-duration network stability | Partial | Prior stress runs exist; a clean v1.0.0 endurance run remains. |
